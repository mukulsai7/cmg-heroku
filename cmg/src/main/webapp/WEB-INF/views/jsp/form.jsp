			...
			<div class="col-10 col-md-8 col-lg-6">
				...
				<form class="form-example" action="submitText" method="post">
					...
					<div class="form-group">
						<label for="name">Name:</label> <input type="text" class="form-control username" id="name"
							placeholder="Name..." name="name" required>
					</div>
					<div class="form-group">
						<label for="phone">Email/Phone:</label> <input type="text" class="form-control number"
							id="contact" placeholder="We may get back to you.." name="contact" required>
					</div>
					<div class="form-group">
						<label for="name">Area of concern zipcode</label> <input type="text" class="form-control email"
							id="zipcode" placeholder="Action will be taken in this area.." name="zipcode" required>
					</div>

					<div class="form-group">
						<label for="area">Area</label> <select id="area" name="area" class="form-control radio"
							required>
						</select>
					</div>
					...
					<div class="form-group">
						<label for="profession">Select ministry/department</label> <select name="ministryOrDept"
							id="ministryOrDept" class="form-control radio" required>
							<option value="">Choose...</option>
					...
					<div class="form-group">
						<label for="comment">Please write your suggestion or issue
							here:</label>
						<textarea class="form-control" rows="5" id="comment" name="suggestionOrIssueText"
							required></textarea>
					</div>

					<label class="radio-inline"><input type="radio" name="submissionType" value="Suggestion"
							checked>Suggestion</label>
					<label class="radio-inline"><input type="radio" name="submissionType" value="Issue">Issue</label>
					</br>
					<button type="submit" id="submit" class="btn btn-primary btn-customized">Submit</button>
					<!-- End input fields -->
				</form>
				<!-- Form end -->
			</div>
